...
//        if (cookies != null) {
//            for (Cookie cookie : cookies) {
//                if ("notice_count_cookie".equals(cookie.getName()) || "reviewDetail_count_cookie".equals(cookie.getName())) {
//                    // 해당 쿠키가 이미 존재하는 경우
//                    String cookieValue = cookie.getValue();
//
//                    //쿠키밸루를 가져와서 _마다 쪼개어 배열로 저장한다.
...
//                    // 현재 날짜와 저장된 날짜를 비교하여 하루에 한 번만 업데이트
//                    if ((boardNoticeNumber.equals(req.getParameter("noticeNumber")) && (currentTimestamp - storedTimestamp) < (24 * 60 * 60 * 1000))
//                    || (boardNoticeNumber.equals(req.getParameter("sitterBoardNumber")))&& (currentTimestamp - storedTimestamp) < (24 * 60 * 60 * 1000)) {
//
//                        //조회수 증가x
//                        return false;
//                    }
